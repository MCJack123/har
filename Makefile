all: libhar.a
    g++ -std=c++11 -ISources -L. har-test/main.cpp -lhar
...
build/File.o: Sources/File.cpp Sources/File.hpp Sources/picosha2.hpp Sources/types.h Sources/DataBuffer.hpp
